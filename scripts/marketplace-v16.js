            ...
            tr.innerHTML = `
                ...
                <td class="px-6 py-8 text-center font-sans">
                    <div class="flex items-center justify-center gap-4">
                        ...
                        <!-- Neon Stock-Style Trend Line (SVG Sparkline) -->
                        <div class="w-16 h-10 flex items-center justify-center overflow-hidden">
                            <svg class="w-14 h-8" viewBox="0 0 45 20">
                                <path d="M 0 18 C 5 18, 10 12, 15 12 C 20 12, 25 2, 30 8 C 35 14, 40 4, 45 4" 
                                      fill="none" 
                                      stroke="#10b981" 
                                      stroke-width="2.5" 
                                      stroke-linecap="round" 
                                      style="filter: drop-shadow(0 0 4px #10b981); opacity: 0.9;"
                                      class="animate-pulse" />
                                <path d="M 0 18 C 5 18, 10 12, 15 12 C 20 12, 25 2, 30 8 C 35 14, 40 4, 45 4 L 45 20 L 0 20 Z" 
                                      fill="url(#neonTrendGradient)" 
                                      opacity="0.15" />
                                <defs>
                                    <linearGradient id="neonTrendGradient" x1="0%" y1="0%" x2="0%" y2="100%">
