const websites = [
    ...
    { url: "http://inkl.com/", name: "Inkl", category: "Technology", price: "$240", tat: "7 Days", da: 47, dr: 49, traffic: "350k", type: "Guest post", links: "DOFOLLOW", description: "Premium curated news service focusing on high-quality journalism, offering a unique opportunity for high-authority guest placement." },
    ...
    { url: "https://www.ilounge.com/", name: "iLounge", category: "Technology", price: "$400", tat: "9 Days", da: 82, dr: 76, traffic: "120k", type: "Guest post", links: "DOFOLLOW", description: "The world's leading independent guide to iPod, iPhone, and iPad digital media, serving a tech-savvy audience since 2001." },
    ...
    { url: "http://ranktracker.com/", name: "Ranktracker", category: "Technology & Marketing", price: "$300", tat: "6 Days", da: 39, dr: 72, traffic: "47k", type: "Guest post", links: "DOFOLLOW", description: "Internationally recognized SEO tool and digital marketing insights platform, trusted by professionals for industry-leading data and guides." },
    { url: "http://technology.org/", name: "Technology", category: "Technology", price: "$400", tat: "7 Days", da: 61, dr: 72, traffic: "113k", type: "Guest post", links: "Dofollow", description: "Global science and technology news hub, featuring daily articles on the latest breakthroughs in research, engineering, and digital innovation." },
    { url: "https://analyticsinsight.net/", name: "Analytics Insight", category: "Technology", price: "$300", tat: "8 Days", da: 70, dr: 81, traffic: "400k", type: "Guest post", links: "DOFOLLOW", description: "The first platform in India to focus on AI, Big Data, and Robotics, reaching thought leaders and tech innovators worldwide." },
    ...
    { url: "https://robinwaite.com/", name: "Robin Waite", category: "Technology", price: "$240", tat: "10 Days", da: 37, dr: 54, traffic: "17k", type: "Link insertion", links: "DOFOLLOW", description: "Strategic business coaching platform and digital insight center, offering high-authority placements for leadership and productivity content." },
    ...
    { url: "https://ecommercefastlane.com/", name: "Ecommerce", category: "Business & Finance", price: "$400", tat: "16 Days", da: 40, dr: 45, traffic: "45k", type: "Guest post", links: "Dofollow", description: "Leading source for Shopify entrepreneurs, scalers, and digital marketers seeking to optimize their online presence." },
    ...
    { url: "https://iemlabs.com/", name: "IEM Labs", category: "Technology", price: "$240", tat: "14 Days", da: 60, dr: 83, traffic: "21k", type: "Guest post", links: "Dofollow", description: "Technical education and cybersecurity excellence platform delivering high-impact industry insights." },
    ...
    { url: "http://networkustad.com/", name: "Network Ustad", category: "Technology", price: "$140", tat: "3-7 Days", da: 62, dr: 70, traffic: "5k", type: "Guest Post", links: "DOFOLLOW", description: "Highly technical blog focusing on networking architecture, server configurations, and hardware reviews." },
    ...
    { url: "https://ocnjdaily.com/", name: "OCNJ Daily", category: "Business & Finance", price: "$160", tat: "3-7 Days", da: 48, dr: 63, traffic: "25k", type: "Guest post", links: "Dofollow", description: "Key news and community updates for Ocean City, providing high local authority placements." },
    { url: "https://seaislenews.com/", name: "Sea Isle News", category: "Business & Finance", price: "$160", tat: "3-7 Days", da: 35, dr: 49, traffic: "8k", type: "Guest post", links: "Dofollow", description: "Reliable source for coastal news and business updates, offering localized link equity." },
    ...
    { url: "https://businessnewstips.com/", name: "Business News Tips", category: "Business & Finance", price: "$200", tat: "3-7 Days", da: 59, dr: 45, traffic: "6.5K", type: "Guest post", links: "Dofollow", description: "Practical enterprise advice and digital marketing tips for small business growth." },
    ...
    { url: "https://hardreset.info/", name: "Hard Reset", category: "Technology", price: "$180", tat: "3-7 Days", da: 60, dr: 60, traffic: "250k", type: "Guest post", links: "Dofollow", description: "Massive database for mobile device instructions, reaching a huge global tech audience." },
    { url: "https://imei.info/", name: "IMEI.info", category: "Technology", price: "$180", tat: "3-7 Days", da: 71, dr: 69, traffic: "1M", type: "Guest post", links: "DOFOLLOW", description: "The internet's primary source for mobile device checking and hardware identification." },
    { url: "https://computertechreviews.com/", name: "Computer Tech Reviews", category: "Technology", price: "$180", tat: "3-7 Days", da: 61, dr: 71, traffic: "7k", type: "Guest post", links: "DOFOLLOW", description: "In-depth hardware analysis and software guides for tech-savvy consumers." },
    ...
    { url: "https://aijourn.com/", name: "AI Journ", category: "Technology", price: "$80", tat: "3-7 Days", da: 42, dr: 69, traffic: "3.5K", type: "Guest post", links: "Do-Follow", description: "Dedicated publication for artificial intelligence news, ethical debates, and futures." },
    { url: "https://idevicecentral.com/", name: "iDevice Central", category: "Technology", price: "$80", tat: "3-7 Days", da: 57, dr: 37, traffic: "4.2K", type: "Guest post", links: "Do-Follow", description: "The primary source for iOS jailbreaking news and mobile hardware tinkering." },
    { url: "https://bestforandroid.com/", name: "Best For Android", category: "Technology", price: "$600", tat: "3-7 Days", da: 48, dr: 62, traffic: "750K", type: "Guest post", links: "Do-Follow", description: "Massive hardware review and mobile software optimization database." },
    { url: "https://computingforgeeks.com/", name: "Computing For Geeks", category: "Technology", price: "OFF", tat: "3-7 Days", da: 50, dr: 73, traffic: "3.5K", type: "Guest post", links: "Do-Follow", description: "Technical documentation and linux system administration tutorials for dev-ops." },
    { url: "https://phandroid.com/", name: "Phandroid", category: "Technology", price: "OFF", tat: "3-7 Days", da: 82, dr: 74, traffic: "7K", type: "Guest post", links: "Do-Follow", description: "The world's first dedicated Android news source with massive authority." },
    { url: "https://www.redmondpie.com/", name: "Redmond Pie", category: "Technology", price: "$260", tat: "3-7 Days", da: 77, dr: 73, traffic: "40K", type: "Guest post", links: "No-Follow", description: "Focusing on technology news, reviews and 'how-to' guides for Microsoft and Apple." },
    { url: "https://applemagazine.com/", name: "Apple Magazine", category: "Technology", price: "$600", tat: "3-7 Days", da: 49, dr: 62, traffic: "30K", type: "Guest post", links: "Do-Follow", description: "Premium lifestyle magazine for enthusiasts of the Apple digital ecosystem." },
    { url: "https://feedbuzzard.com/", name: "Feed Buzzard", category: "Technology", price: "$340", tat: "3-7 Days", da: 56, dr: 66, traffic: "14K", type: "Guest post", links: "Do-Follow", description: "Aggregating the best in technology news and viral digital marketing trends." },
    { url: "https://viraltimesmagazine.com/", name: "Viral Times", category: "Technology", price: "$60", tat: "3-7 Days", da: 66, dr: 54, traffic: "7K", type: "Guest post", links: "Do-Follow", description: "Capturing the zeitgeist of internet culture and emerging tech sensations." },
    { url: "https://disquantified.org/", name: "Disquantified", category: "Technology", price: "$240", tat: "3-7 Days", da: 50, dr: 64, traffic: "13.5K", type: "Guest post", links: "Do-Follow", description: "Exploring the data-driven world through a technical and humanitarian lens." },
    { url: "https://turdwords.com/", name: "Turd Words", category: "Technology", price: "$70", tat: "3-7 Days", da: 19, dr: 18, traffic: "5.5K", type: "Guest post", links: "Do-Follow", description: "Niche blog focusing on software development oddities and creative tech writing." },
    ...
    { url: "https://www.speakrj.com/", name: "Speak RJ", category: "Technology", price: "$160", tat: "3-7 Days", da: 39, dr: 42, traffic: "30K", type: "Guest post", links: "Do-Follow", description: "Social media analytics and technical influencer marketing insights platform." }
];
...
document.addEventListener('DOMContentLoaded', () => {
            ...
            tr.innerHTML = `
                <td class="px-8 py-8">
                    <div class="flex items-center gap-6">
                        ...
                        <div class="max-w-[400px]">
                            ...
                            <!-- Fixed: Removed line-clamp-2 to show full description -->
                            <p class="text-[13px] font-medium text-black leading-snug italic font-sans">${site.description}</p>
                        </div>
                    </div>
                </td>
                ...
                <td class="px-6 py-8 text-center font-sans">
                    <div class="flex items-center justify-center gap-4">
                        ...
                        <!-- Original Mini Trend Bar Graph (Restored) -->
    ...
    function filterData() {
        ...
        filteredData = websites.filter(site => {
            ...
            let matchesCategory = activeCategory === 'All Categories';
            if (!matchesCategory) {
                // Strategic mapping for fuzzy category matches
                if (activeCat === 'technology') {
                    matchesCategory = category.includes('tech') || category.includes('digital') || category.includes('app') || category.includes('software');
                } else if (activeCat === 'business & finance' || activeCat === 'business and finance') {
                    matchesCategory = category.includes('business') || category.includes('finance') || category.includes('economic') || category.includes('enterprise');
                } else {
                    matchesCategory = category.includes(activeCat);
                }
            }
