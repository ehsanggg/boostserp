            ...
            tr.innerHTML = `
                ...
                <td class="px-6 py-8 text-center font-sans">
                    <div class="flex items-center justify-center gap-4">
                        ...
                        <!-- Stock-Style Trend Line (SVG Sparkline) -->
                        <div class="w-16 h-10 flex items-center justify-center overflow-hidden">
                            <svg class="w-14 h-6" viewBox="0 0 45 20">
                                <path d="M 0 18 Q 10 18, 15 12 T 25 8 T 35 15 T 45 4" 
                                      fill="none" 
                                      stroke="#10b981" 
                                      stroke-width="2.5" 
                                      stroke-linecap="round" 
                                      class="animate-pulse" />
                                <path d="M 0 18 Q 10 18, 15 12 T 25 8 T 35 15 T 45 4 L 45 20 L 0 20 Z" 
