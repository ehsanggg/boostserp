const websites = [
    ...
    { url: "http://hollywoodprogressive.com/", name: "Hollywood Progressive", category: "Food and Entertainment", price: "$160", tat: "3-7 Days", da: 37, dr: 33, traffic: "20k", type: "Guest Post", links: "Dofollow", description: "Connecting the entertainment industry with social commentary and political updates for a wide demographic." },
    ...
    { url: "https://ceoweekly.com/", name: "CEO Weekly", category: "General", price: "$160", tat: "3-7 Days", da: 61, dr: 67, traffic: "1k", type: "Guest Post", links: "Dofollow", description: "Leading online source for executive profiles, business strategies, and corporate success stories." },
    ...
    { url: "https://hardreset.info/", name: "Hard Reset", category: "General", price: "$180", tat: "3-7 Days", da: 60, dr: 60, traffic: "250k", type: "Guest post", links: "Dofollow", description: "Massive database for mobile device instructions, reaching a huge global tech audience." },
    { url: "https://imei.info/", name: "IMEI.info", category: "General", price: "$180", tat: "3-7 Days", da: 71, dr: 69, traffic: "1M", type: "Guest post", links: "DOFOLLOW", description: "The internet's primary source for mobile device checking and hardware identification." },
    { url: "https://computertechreviews.com/", name: "Computer Tech Reviews", category: "General", price: "$180", tat: "3-7 Days", da: 61, dr: 71, traffic: "7k", type: "Guest post", links: "DOFOLLOW", description: "In-depth hardware analysis and software guides for tech-savvy consumers." },
    ...
    { url: "https://monomousumi.com/", name: "Monomousumi", category: "General", price: "$180", tat: "3-7 Days", da: 59, dr: 55, traffic: "60k", type: "Guest post", links: "DOFOLLOW", description: "Educational and creative writing platform with huge search volume and organic growth." },
    ...
    { url: "https://www.urbansplatter.com/", name: "Urban Splatter", category: "General", price: "$200", tat: "3-7 Days", da: 45, dr: 60, traffic: "32k", type: "Guest post", links: "DOFOLLOW", description: "High-authority architecture and urban design blog with a massive design-focused audience." },
    ...
    { url: "http://sheenmagazine.com/", name: "Sheen Magazine", category: "General", price: "$880", tat: "3-7 Days", da: 64, dr: 69, traffic: "7k", type: "Guest Post", links: "Dofollow", description: "The ultimate beauty guide and celebrity lifestyle source for the urban demographic." },
    ...
    { url: "https://www.geniusfirms.com/", name: "Genius Firms", category: "Tech", price: "$160", tat: "3-7 Days", da: 36, dr: 60, traffic: "11K", type: "Guest post", links: "Do-Follow", description: "Recognizing the most innovative and technical companies in the digital world." },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderTable() {
        ...
        filteredData.forEach((site, index) => {
            ...
            // Generate HTML for DA/DR Circular Progress with placeholders for count-up
            tr.innerHTML = `
                <td class="px-8 py-10">
                    <div class="flex items-center gap-6">
                        ...
                        <div class="max-w-[400px]">
                            <div class="flex items-center gap-2 mb-1">
                                <a href="${site.url}" target="_blank" class="font-black text-primary-blue text-xl font-sans italic tracking-tight hover:text-slate-900 transition-colors underline decoration-primary-blue/0 hover:decoration-primary-blue/30 decoration-2 underline-offset-4 flex items-center gap-2">
                                    ${site.name}
                                    <i data-lucide="external-link" class="w-3.5 h-3.5"></i>
                                </a>
                            </div>
                            <p class="text-[14px] font-medium text-black leading-snug group-hover:text-black transition-colors italic font-sans">${site.description || 'Global authority platform delivering high-impact backlinks and massive organic reach for premium SEO growth.'}</p>
                        </div>
                    </div>
                </td>
                <td class="px-6 py-10 font-sans">
                    <div class="flex items-center gap-8 justify-center">
                        <!-- DA Circle -->
                        <div class="flex flex-col items-center gap-2 metric-trigger" data-value="${site.da || 0}" data-type="da">
                            <div class="relative w-14 h-14 flex items-center justify-center">
                                <svg class="dr-circle-svg w-14 h-14" width="40" height="40" viewBox="0 0 40 40">
                                    <circle class="dr-circle-bg" cx="20" cy="20" r="${radius}"></circle>
                                    <circle class="dr-circle-progress da-progress-circle" cx="20" cy="20" r="${radius}" 
                                            stroke-dasharray="${circumference}" 
                                            stroke-dashoffset="${circumference}"
                                            style="stroke: #0ea5e9"></circle>
                                </svg>
                                <span class="absolute text-[13px] font-black text-black da-counter">0</span>
                            </div>
                            <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest">DA</span>
                        </div>

                        <!-- DR Circle -->
                        <div class="flex flex-col items-center gap-2 metric-trigger" data-value="${site.dr || 0}" data-type="dr">
                            <div class="relative w-14 h-14 flex items-center justify-center">
                                <svg class="dr-circle-svg w-14 h-14" width="40" height="40" viewBox="0 0 40 40">
                                    <circle class="dr-circle-bg" cx="20" cy="20" r="${radius}"></circle>
                                    <circle class="dr-circle-progress dr-progress-circle" cx="20" cy="20" r="${radius}" 
                                            stroke-dasharray="${circumference}" 
                                            stroke-dashoffset="${circumference}"
                                            style="stroke: #10b981"></circle>
                                </svg>
                                <span class="absolute text-[13px] font-black text-black dr-counter">0</span>
                            </div>
                            <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest">DR</span>
                        </div>
                    </div>
                </td>
